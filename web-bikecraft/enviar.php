...
// Mudar Aqui o e-mail
$email_envio = "contato@claudiovitor.com"; // E-mail do site (ex: contato@seusite.com)
$email_pass = "claudio"; // Senha do e-mail

$site_name = "Bikcraft"; // Nome do Site
$site_url = "www.bikcraftclaudio.com"; // URL do Site

$host_smtp = "servidor.hostgator.com.br"; // HOST SMTP Ex: smtp.domain.com.br
